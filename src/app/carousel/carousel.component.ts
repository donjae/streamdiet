...
@Component({
  ...
  template: `
    ...
    <div style="margin-top: 1em">
      <button *ngIf="showPrevControls" (click)="prev()" class="btn btn-default">Prev</button>
      <button *ngIf="showPrevControls" (click)="next()" class="btn btn-default">Next</button>
    </div>
  `,
...
export class CarouselComponent implements AfterViewInit {
  ...
  @Input() showPrevControls = true;
  @Input() showNextControls = true;
  ...
  constructor(
    ...
    // this.emitterService.widthEmitter.subscribe(width => this.newsWidth = width)
  }
